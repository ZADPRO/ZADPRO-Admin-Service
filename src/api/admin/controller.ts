...
export class adminController {
  ...
  public addProducts = async (
    ...
    try {
      ...
      logger.error("Error in addProducts", error);
      return response
        .response({
          success: false,
          message:
  ...
  public addNewAdmin = async (
    ...
    try {
      ...
      logger.error("Error in addNewAdmin", error);
      return response
        .response({
          success: false,
          message:
  ...
  public allProductData = async (
    ...
    try {
      ...
      logger.error("Error in allProductData", error);
      return response
        .response({
          success: false,
          message:
  ...
  public visibleAccess = async (
    ...
    try {
      ...
      logger.error("Error in visibleAccess", error);
      return response
        .response({
          success: false,
          message:
  ...
  public uploadProductLogo = async (
    request: any,
    response: Hapi.ResponseToolkit
  ): Promise<any> => {
    logger.info(`GET URL REQ => ${request.url.href}`);
    try {
      ...
      logger.error("Error in uploadProductLogo", error);
      return response
        .response({
          success: false,
          message:
  ...
  public editAdmin = async (
    ...
    try {
      ...
      logger.error("Error in editAdmin", error);
      return response
        .response({
          success: false,
          message:
  ...
  public listAdmin = async (
    ...
    try {
      ...
      logger.error("Error in listAdmin", error);
      return response
        .response({
          success: false,
          message:
